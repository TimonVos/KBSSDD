...
namespace Service.UnitTest.Database.Model
{
    ...
    internal class CompetenceTest
    {
        ...
        public void Competences_can_be_created()
        {
            ...
            competence = (from i in createContext.Competences
                          where i.CompetenceId == competence.CompetenceId
        ...
        public void Competences_can_be_read()
        {
            ...
            var read = (from i in readContext.Competences
                        where i.CompetenceId == competence.CompetenceId
                        select i).Include(c => c.Form).FirstOrDefault();
            Assert.Multiple(() =>
            {
        ...
        public void Competences_can_be_updated()
        {
            ...
            updateForm = (from f in readContext.Forms
                    where f.FormId == updateForm.FormId
                    select f).FirstOrDefault();
        ...
        public void Competences_can_be_deleted()
        {
            ...
            competence = (from i in deleteContext.Competences
                          where i.CompetenceId == competence.CompetenceId
                          select i).FirstOrDefault();
